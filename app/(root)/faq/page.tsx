      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-4">
          {faqs.map((faq, index) => (
            <div
              key={index}
              className="bg-white dark:bg-slate-900 rounded-xl shadow-lg p-6 hover:shadow-xl border border-gray-200 dark:border-slate-800 hover:border-indigo-300 dark:hover:border-slate-600 transition-all duration-300"
            >
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3 flex items-start gap-3 transition-colors duration-300">
              ...
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed ml-11 transition-colors duration-300">
                {faq.answer}
              </p>
            </div>
          ))}
