  ...
  return (
    <div className="flex items-center gap-1">
      ...
      <form action={handleDelete}>
        ...
        <button
          className=" cursor-pointer p-2 text-red-600 hover:bg-red-50 dark:hover:bg-white dark:text-red-600 dark:hover:text-red-700 duration-300 rounded-lg transition-colors"
          type="submit"
